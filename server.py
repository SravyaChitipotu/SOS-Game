...
# Initialize clients, user_request_queue, and server_socket
...
def check_queue():
    ...
    for client in clients:
              ...
              client.close()
    if user_request_queue.empty():
         server_socket.close()
    else:
         print("228")
         authenticate_user(user_request_queue[0])
         authenticate_user(user_request_queue[1])
         user_request_queue = deque(user_request_queue)
